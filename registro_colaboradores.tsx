...
export default function App() {
        ...
        <div className="flex justify-between items-center mb-6 bg-white p-4 rounded-xl shadow-sm border border-slate-200">
          ...
          <div className="relative">
            ...
            <button 
              ...
              className="flex items-center space-x-2 bg-slate-800 hover:bg-slate-700 text-white px-4 py-2.5 rounded-lg font-medium transition-colors shadow-sm text-sm"
            ...
            return (
              <button
                ...
                className={`p-4 rounded-xl border-2 transition-all duration-200 flex flex-col items-center justify-center space-y-2
                  ${hasSocio 
                    ? 'border-blue-500 bg-blue-50 text-blue-900 hover:bg-blue-100 hover:shadow-md' 
                    : 'border-slate-200 bg-white text-slate-400 hover:border-slate-300 hover:bg-slate-50'}`}
              >
                <span className="text-sm font-semibold opacity-70">DISCO</span>
  ...
  return (
    <div className="min-h-screen bg-slate-100 font-sans">
      <header className="bg-slate-900 shadow-lg sticky top-0 z-10 border-b-4 border-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between py-4">
          <div className="flex items-center space-x-4 text-white">
            ...
            <div>
              <h1 className="text-xl md:text-2xl font-bold leading-tight">Control de Colaboradores</h1>
              <p className="text-blue-300 text-sm md:text-base font-medium">Consejo de vigilancia 2026-2027</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSearch} className="flex-1 max-w-sm mx-4 hidden sm:block">
            <div className="relative">
              ...
              <input
                type="number"
                min="1" max="61"
                className="block w-full pl-12 pr-4 py-3 border-2 border-slate-700 rounded-xl leading-5 bg-slate-800 text-white placeholder-slate-400 focus:outline-none focus:bg-white focus:text-slate-900 focus:border-blue-500 transition-colors text-lg"
                placeholder="Buscar disco (1-61)..."
                value={searchDisco}
      ...
      <main className="pb-16 pt-8">
        {activeDisco === null ? renderGrid() : renderSocioView()}
      </main>
